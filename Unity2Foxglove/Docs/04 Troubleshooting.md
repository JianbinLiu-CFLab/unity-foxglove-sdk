...
2. **Rebuild the Library directory**:
   - Close Unity Hub
   - Delete the `Unity2Foxglove/Library/` directory (keep other files and directories)
...
2. **Confirm correct file path**:
   ...
   - The path is relative to the repository root (not the `Unity2Foxglove/` project directory)
