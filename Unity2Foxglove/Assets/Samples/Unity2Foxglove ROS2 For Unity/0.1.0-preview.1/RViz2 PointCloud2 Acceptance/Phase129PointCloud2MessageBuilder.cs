...
// Purpose: Maps SDK packed point-cloud frames to the RViz2 point cloud message.

using System;
using Unity.FoxgloveSDK.Schemas;
using Unity.FoxgloveSDK.Schemas.PointCloud;

public static class Phase129PointCloud2MessageBuilder
{
    ...
    public static sensor_msgs.msg.PointCloud2 Build(PointCloudFrame frame, int sec, uint nanosec)
    {
        ...
        {
            Header = CreateHeader(frame.FrameId ?? string.Empty, sec, nanosec),
            Height = 1u,
            Width = width,
