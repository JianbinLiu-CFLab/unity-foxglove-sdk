...
// Purpose: Native LiDAR PackedPointCloud packed data construction without managed point objects.
...
{
    /// <summary>Fine-grained pack timings for PackedPointCloud worker stall diagnostics.</summary>
    internal struct PackedPointCloudPackTimings
    {
    ...
    /// <summary>Builds PackedPointCloud packed bytes from native LiDAR point snapshots.</summary>
    internal static class PackedPointCloudDataBuilder
    {
        ...
        /// <summary>
        /// Builds the full SLAM PackedPointCloud field layout from compacted valid
        ...
        /// <summary>
        /// Builds the full SLAM PackedPointCloud field layout from the first
        ...
        internal static PointCloudPackedData BuildVirtualLidarFullStridePooled(
            ...
            bool emitAbsoluteTimeNs,
            bool collectTimings,
            out PackedPointCloudPackTimings timings,
            bool useAcquisitionFrameCoordinates = false,
            bool zeroTimeOffset = false,
            bool preserveSourcePointCount = false,
            bool preferPooledBufferRetention = false)
        ...
        private static int ValidatePackedDataBudget(int pointCount, uint stride)
        {
            ...
            if (packedBytes > PointCloudPackedDataBuilder.MaxPackedDataBytes)
            {
                throw new InvalidOperationException(
                    $"PackedPointCloud packed data exceeds {PointCloudPackedDataBuilder.MaxPackedDataBytes} bytes ({packedBytes} requested).");
            }
