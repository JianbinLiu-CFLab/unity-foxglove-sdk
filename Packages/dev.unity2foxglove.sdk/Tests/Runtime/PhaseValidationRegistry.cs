...
namespace Unity.FoxgloveSDK.Tests
{
    ...
    internal static class PhaseValidationRegistry
    {
        ...
        public static IReadOnlyList<PhaseValidationCase> All { get; } = new[]
        {
            ...
            Ci("--phase147", "Phase 147: generated-source literal and determinism validation", Phase147Validation.Validate),
            ...
            Ci("--phase154", "Phase 154: validation for FoxRun message aggregation and schema inference", Phase154Validation.Validate),
            ...
            Ci("--phase183a", "FoxRun declaration and full-duplex update policy", FoxRunDeclarationModelValidation.Validate, includeInDefault: true,
                evidence: ValidationEvidence.Behavior | ValidationEvidence.Structural),
            Ci("--phase184a", "FoxRun clean declaration API and endpoint legality matrix", FoxRunProfileModelValidation.ValidatePhase184A, includeInDefault: true,
                evidence: ValidationEvidence.Behavior | ValidationEvidence.Structural),
            Ci("--phase184b", "FoxRun frozen directional publish and subscribe profiles", FoxRunProfileModelValidation.ValidatePhase184B, includeInDefault: true,
                evidence: ValidationEvidence.Behavior),
            Ci("--phase184c", "FoxRun portable ROS 2 QoS profile resolution", FoxRunProfileModelValidation.ValidatePhase184C, includeInDefault: true,
                evidence: ValidationEvidence.Behavior),
            Ci("--phase184d", "FoxRun conditional input, isolated multi-target fanout, and origin governance", FoxRunProfileModelValidation.ValidatePhase184D, includeInDefault: true,
                evidence: ValidationEvidence.Behavior),
            Ci("--phase184e", "FoxRun bounded input streams and package hygiene", FoxRunProfileModelValidation.ValidatePhase184E, includeInDefault: true,
                evidence: ValidationEvidence.Behavior | ValidationEvidence.Structural),
            Ci("--phase185a",
                "FoxRun MessagePack public contract and source shape",
                FoxRunMessagePackPublicContractValidation.Validate,
                includeInDefault: true,
                evidence: ValidationEvidence.Structural),
            Ci("--phase185b",
                "FoxRun MessagePack generated publish and fanout integration",
                FoxRunMessagePackPublishFanoutValidation.Validate,
                includeInDefault: true,
                evidence: ValidationEvidence.Structural),
            Ci("--phase185c",
                "FoxRun MessagePack generated bounded input integration",
                FoxRunMessagePackBoundedInputValidation.Validate,
                includeInDefault: true,
                evidence: ValidationEvidence.Structural),
            Ci("--phase185d",
                "FoxRun MessagePack duplex tooling and MCAP compatibility",
                FoxRunMessagePackDuplexToolingValidation.Validate,
                includeInDefault: true,
                evidence: ValidationEvidence.Structural | ValidationEvidence.Conformance),
            Ci("--phase185e",
                "FoxRun MessagePack artifact sample and package acceptance",
                FoxRunMessagePackArtifactAcceptanceValidation.Validate,
                includeInDefault: true,
                evidence: ValidationEvidence.Structural),
            Ci("--phase186",
                "ROS-free core and bidirectional ROS2 Bridge",
                Ros2BridgeBidirectionalValidation.Validate,
                includeInDefault: true,
                evidence: ValidationEvidence.Structural | ValidationEvidence.Conformance),
            ...
            Ci("--phase163-57", "Phase 163-57: phase163-57 review regression coverage for unit, conformance, and performance test hygiene", Phase163_57Validation.Validate, includeInDefault: true,
                evidence: ValidationEvidence.Structural | ValidationEvidence.Conformance | ValidationEvidence.Performance),
            Ci("--phase163-58", "Phase 163-58: phase163-58 regression coverage for isolated local CI dotnet build roots", Phase163_58Validation.Validate, includeInDefault: true),
            ...
            Ci("--phase164-14", "Phase 164-14", Phase164_14Validation.Validate, includeInDefault: true),
            ...
            Ci("--phase164-21", "Phase 164-21", Phase164_21Validation.Validate, includeInDefault: true),
            Ci("--phase164-22", "Phase 164-22", Phase164_22Validation.Validate),
            Ci("--phase164-23", "Phase 164-23", Phase164_23Validation.Validate),
            Ci("--phase164-24", "Phase 164-24", Phase164_24Validation.Validate),
            ...
            Ci("--phase164-49", "Phase 164-49", Phase164_49Validation.Validate),
