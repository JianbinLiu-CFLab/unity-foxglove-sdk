...
namespace Unity.FoxgloveSDK.Tests
{
    ...
    public static class Phase73Validation
    {
        ...
        private static void VerifyHeavyPublisherGuards()
        {
            ...
            CheckOrdered(pointUpdate, "ShouldPreparePublishPayload()", "_transformPointCloudSource.CreateFrameFromTransforms", "73G-10: point cloud preflights before child transform scan");
