    ...
    public static class Phase163_32Validation
    {
        ...
        private static void LyricalZenohPlayModeRequiresRunningRouter()
        {
            ...
            Check(onPlayMode.Contains("OnExitingEditMode();", StringComparison.Ordinal)
                  ...
                  && guard.Contains("_foxRunPublishTransportIds", StringComparison.Ordinal)
                  ...
                  && guard.Contains("_foxRunSubscribeTransportId", StringComparison.Ordinal)
                  && nativeDemand.Contains("CaptureLoadedScenes()", StringComparison.Ordinal)
                  && nativeDemand.Contains("HasExplicitPublishTransport(R2fuProviderId)", StringComparison.Ordinal)
                  && nativeDemand.Contains("HasExplicitSubscribeTransport(R2fuProviderId)", StringComparison.Ordinal)
                  && nativeDemand.Contains("FindProperty(", StringComparison.Ordinal)
                  && nativeDemand.Contains("PublishTransportIdsSerializedProperty", StringComparison.Ordinal)
                  && nativeDemand.Contains("SubscribeTransportIdSerializedProperty", StringComparison.Ordinal)
                  && nativeDemand.Contains("SerializedArrayContains(publishIds, R2fuProviderId)", StringComparison.Ordinal)
