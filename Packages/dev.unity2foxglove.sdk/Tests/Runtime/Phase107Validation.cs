...
{
    /// <summary>
    /// Validation type for Phase107Validation.
    /// </summary>
    public static class Phase107Validation
    {
        ...
        private const string JazzyArtifactSha256 = "f20f20047d1a2087aad1d9e280c7a04943935d9019793b3f11d399ec54899232";
        ...
        private static void VerifyDocsBoundary()
        {
            ...
            Check(roadmap.Contains("one-repo, multi-package", StringComparison.Ordinal)
                  && roadmap.Contains("ROS2 For Unity adapter/runtime package line", StringComparison.Ordinal)
