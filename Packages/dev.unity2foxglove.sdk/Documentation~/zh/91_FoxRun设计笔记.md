...
```mermaid
flowchart TD
  Root["Editor/SourceGenerators"]
  Props["Directory.Build.props"]
  Csproj["FoxgloveLogSourceGenerator.csproj"]
  Src["src"]
  Generator["FoxgloveLogSourceGenerator.cs"]
  Asmdef["Unity.FoxgloveSDK.SourceGenerators.asmdef"]
  Analyzers["analyzers/dotnet/cs"]
  Dll["FoxgloveLogSourceGenerator.dll"]
