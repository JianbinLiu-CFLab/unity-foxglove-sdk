...
namespace Unity.FoxgloveSDK.Editor
{
    ...
    /// transport-neutral serialization capabilities.
    /// </summary>
    public static class FoxgloveSdkPublisherCatalog
    {
        private static readonly Unity2FoxgloveSdkTypedPublisherEntry[]
            EntriesArray =
            {
                Concrete(
                    ...
                    "Transform publisher for frame transforms."),
                Concrete(
                ...
                Template(
                    ...
                    supportsJson: false,
                    supportsProtobuf: true,
                    "Generic protobuf publisher template; its concrete schema is supplied by T.")
            };

        public static IReadOnlyList<Unity2FoxgloveSdkTypedPublisherEntry>
            Entries { get; } = Array.AsReadOnly(EntriesArray);
