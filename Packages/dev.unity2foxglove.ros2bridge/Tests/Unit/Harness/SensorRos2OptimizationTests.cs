    ...
    public sealed class PointCloudLaserScanOptimizationTests
    {
        ...
        public void PointCloudAndLaserScanHotPathsReuseScannedState()
        {
            ...
            var publisher = string.Concat(
                ...
                TestSources.Text("Packages/dev.unity2foxglove.sdk/Runtime/Schemas/Proto/Publishers/FoxglovePointCloudPublisher.PackedPointCloud.cs"),
            ...
            var bridgeProvider = TestSources.Text(
                "Packages/dev.unity2foxglove.ros2bridge/Runtime/Schemas/Ros2Msg/Generated/Ros2BridgeTransportProvider.cs");
            var rosPointCloud = TestSources.Text(
                "Packages/dev.unity2foxglove.ros2bridge/Runtime/Schemas/Ros2Msg/Builders/Ros2CdrPointCloudBuilder.cs");
            var rosPointCloud2 = TestSources.Text(
                "Packages/dev.unity2foxglove.ros2bridge/Runtime/Schemas/Ros2Msg/Builders/Ros2CdrSensorPointCloud2Builder.cs");
            ...
            Assert.Contains("PointCloudMessageBuilder.CreateProtobuf(frame, packedLayout)", publisher, StringComparison.Ordinal);
            Assert.Contains("PointCloudPackedDataBuilder.Build(frame, packedLayout)", publisher, StringComparison.Ordinal);
            Assert.Contains("Ros2CdrSensorPointCloud2Builder.Serialize(", bridgeProvider, StringComparison.Ordinal);
            Assert.Contains("pointCloud2.Fields", bridgeProvider, StringComparison.Ordinal);
            Assert.Contains("pointCloud2.Data", bridgeProvider, StringComparison.Ordinal);
            Assert.DoesNotContain("PointCloudPackedDataBuilder.Build", bridgeProvider, StringComparison.Ordinal);
            Assert.Contains("PointCloudPackedDataBuilder.BuildPooled(frame, layout)", rosPointCloud, StringComparison.Ordinal);
            Assert.Contains("PointCloudPackedDataBuilder.BuildPooled(frame, layout)", rosPointCloud2, StringComparison.Ordinal);
