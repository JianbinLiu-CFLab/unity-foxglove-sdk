...
namespace Unity.FoxgloveSDK.Editor
{
    internal static class Ros2InputDispatchEmitter
    {
            ...
            IReadOnlyList<string> publishTopics)
        {
            ...
            sb.AppendLine(pad + "partial class " + escapedClassName + " : " + NativeNamespace + "IFoxRunRos2SubscriptionSource");
            sb.AppendLine(pad + "{");
        ...
        private static string TriggerFieldSuffix(IFoxRunR2fuEmitterMember member)
        ...
        private static string SourceLiteral(string provider)
        {
            if (string.Equals(
                ...
                return NativeNamespace + "FoxRunRos2RouteEndpoint.R2fu";
            if (string.Equals(
                    provider,
                    FoxRunR2fuGenerationConstants.WebSocketProviderId,
                    StringComparison.Ordinal))
                return NativeNamespace + "FoxRunRos2RouteEndpoint.WebSocket";
            return "(" + NativeNamespace + "FoxRunRos2RouteEndpoint)0";
        }
        ...
        {
            return "(global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosProfile)0";
        }

        private static string QosReliabilityLiteral(string value)
        {
            if (string.Equals(value, "reliable", StringComparison.Ordinal))
                return "global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosReliability.Reliable";
            if (string.Equals(value, "best-effort", StringComparison.Ordinal))
                return "global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosReliability.BestEffort";
            if (string.Equals(value, "system-default", StringComparison.Ordinal))
                return "global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosReliability.SystemDefault";
            return "(global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosReliability)0";
        }

        private static string QosDurabilityLiteral(string value)
        {
            if (string.Equals(value, "volatile", StringComparison.Ordinal))
                return "global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosDurability.Volatile";
            if (string.Equals(value, "transient-local", StringComparison.Ordinal))
                return "global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosDurability.TransientLocal";
            if (string.Equals(value, "system-default", StringComparison.Ordinal))
                return "global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosDurability.SystemDefault";
            return "(global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosDurability)0";
        }

        private static string QosHistoryLiteral(string value)
        {
            if (string.Equals(value, "keep-last", StringComparison.Ordinal))
                return "global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosHistory.KeepLast";
            if (string.Equals(value, "keep-all", StringComparison.Ordinal))
                return "global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosHistory.KeepAll";
            if (string.Equals(value, "system-default", StringComparison.Ordinal))
                return "global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosHistory.SystemDefault";
            return "(global::Unity2Foxglove.Ros2ForUnity.Native.FoxRunQosHistory)0";
        }
        ...
        private static string ConditionDelegate(IFoxRunR2fuEmitterMember member)
        {
        ...
        {
            var value = IdentifierUtils.EscapeTypeName(typeName ?? string.Empty);
