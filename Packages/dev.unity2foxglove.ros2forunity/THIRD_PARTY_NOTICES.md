...
This optional package prepares a future ROS2 For Unity integration boundary for Unity2Foxglove.

Phase 107 does not bundle the ROS2 For Unity runtime asset, generated message assemblies, native ROS2 libraries, Fast DDS/RMW components, or ros2cs binaries. Runtime binaries are not bundled in this package yet.
...
- **Phase 107 release evidence**: `Ros2ForUnity_humble_standalone_windows11.zip`, version `1.3.0`
...
- **Bundle status**: not bundled in Phase 107

Unity2Foxglove does not claim authorship of ros2cs. If a later phase bundles ROS2 For Unity runtime artifacts, the package must include a complete transitive inventory covering ros2cs and every redistributed native or managed dependency.

## Future Binary Bundling Boundary

Before this package redistributes any runtime binary, generated metadata file, generated message assembly, or extracted ROS2 For Unity asset, a later phase must update:
...
Until then, this package is only an attribution, compliance, and installation-boundary placeholder.
