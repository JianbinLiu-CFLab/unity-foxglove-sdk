...
```text
paste output from Scripts/smoke/websocket/pointcloud_qos_probe.py
```

## Compressed Probe Output

```text
paste output from Scripts/smoke/websocket/compressed_pointcloud_draco_probe.py
```
...
```text
paste output from Scripts/smoke/mcap/compressed_pointcloud_mcap_inspect.py
```
