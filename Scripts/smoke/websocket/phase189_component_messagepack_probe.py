...
# Usage: python Scripts/smoke/websocket/phase189_foxrun_messagepack_probe.py --url ws://127.0.0.1:8765 --output build/phase189/probe/report.json
...
CATALOG_SERVICE = "/foxglove/component-publish-contracts"
PROBE_TOPIC = "/phase189/messagepack/full-duplex"
APPLY_EVIDENCE_TOPIC = "/phase189/messagepack/apply-evidence"
...
class ProbeFailure(RuntimeError):
    """Raised when live evidence cannot satisfy the Phase189 contract."""
