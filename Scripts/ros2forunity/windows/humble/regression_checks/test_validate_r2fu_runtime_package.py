...
VALIDATOR_PATH = ROOT / "Scripts" / "ros2forunity" / "windows" / "humble" / "validate_r2fu_runtime_package.py"
...
class RuntimePackageValidatorTests(unittest.TestCase):
    ...
    def test_inventory_category_counts_must_match_file_entries(self) -> None:
        ...
        files = [
            ...
            {"path": "Ros2ForUnity/generated.dll", "category": "generated_message_assemblies"},
        ]
        ...
        self.assertTrue(
            self.validator.inventory_category_counts_match(
                {"native_libraries": 1, "generated_message_assemblies": 1},
                files,
            )
        )
    ...
    def test_public_docs_must_include_artifact_hash(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            readme.write_text(
                "runtime.humble.win64 adapter combined Unity2Foxglove workflow\n"
