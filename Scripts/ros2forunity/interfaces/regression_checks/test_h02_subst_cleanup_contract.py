...
class H02SubstCleanupTests(unittest.TestCase):
 def test_cleanup_status_is_checked_without_masking_primary(self):
  t=SRC.read_text(encoding='utf-8'); self.assertIn('primary_error: BaseException | None = None',t); self.assertIn('cleanup.returncode != 0',t); self.assertIn('if primary_error is None',t)
