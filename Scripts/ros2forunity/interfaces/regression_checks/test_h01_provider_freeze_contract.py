...
class H01ProviderFreezeTests(unittest.TestCase):
    ...
    def test_registration_freezes_id_and_capabilities(self):
        ...
        self.assertIn('RegisteredProvider', t)
        self.assertIn('private readonly Dictionary<IFoxRunTransportProvider, RegisteredProvider>', t)
        self.assertIn('public FoxRunTransportId Id { get; }', t)
