...
Common usage:
    ...
    python Scripts/mcap/mcap_time_sync.py
    python Scripts/mcap/mcap_time_sync.py --mcap Unity2Foxglove/Recordings/my_run.mcap
    python Scripts/mcap/mcap_time_sync.py --skip-frames 80
"""
