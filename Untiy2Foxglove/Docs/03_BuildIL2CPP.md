...
If `[FoxrunBuildPreprocess]` is missing, FoxRun log topics may not be generated correctly. Check whether `Untiy2Foxglove/Assets/Scripts/Generated/*_FoxRun.g.cs` files exist.
...
Verify each item according to **[02_FoxgloveManualAcceptance.md](02_FoxgloveManualAcceptance.md)**, with special attention to:
...
**Resolution**: check whether `.cs` files exist under `Untiy2Foxglove/Assets/Scripts/Generated/`. If they do not exist, first open the project in the Unity Editor and compile once to ensure the Source Generator triggers.
...
- See **[04_DemoTroubleshooting.md](04_DemoTroubleshooting.md)** for more troubleshooting
