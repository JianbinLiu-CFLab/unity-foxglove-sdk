...
[![Release](https://img.shields.io/badge/release-v1.1.0-green)](https://github.com/JianbinLiu-CFLab/unity-foxglove-sdk/releases)
...
- A pure C# WebSocket server for Unity Editor and Standalone Player. Windows is verified for v1.1.0; macOS/Linux are intended targets but not yet verified.
